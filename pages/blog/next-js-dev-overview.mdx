...
tags:
    -nextjs
    -learning
image_path: '/next-js-dev-overview/macintosh.jpg'
image_web_addr: 'https://pixabay.com/users/stocksnap-894430/?utm_source=link-attribution&utm_medium=referral&utm_campaign=image&utm_content=2619617' 
image_by: 'StockSnap'
---
...
2. <InterSiteLink text={'Work through the NextJS tutorial'} to={'/blog/next-js-dev-part-2'} />
3. <InterSiteLink text={'Make my own project using what I learned from the tutorial'} to={'/blog/next-js-dev-part-3'} />
4. <InterSiteLink text={'Use the project with Storybook to speed up component design'} to={'/blog/next-js-dev-part-4'} />
5. <InterSiteLink text={'Wire in custom components'} to={'/blog/next-js-dev-part-5'} />
6. <InterSiteLink text={'Deploy'} to={'/blog/next-js-dev-part-6'} />
