...
4. <InterSiteLink text={'Initialize the project with [Storybook](https://storybook.js.org/) to speed up component design'} to={'/blog/next-js-dev-part-4'} />
5. Add custom components to the proejct (i.e. a nav bar, layouts, etc) 
6. Deploy
