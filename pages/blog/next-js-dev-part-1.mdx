...
<CenteredImage caption={"A screenshot of my Recent Posts page sketch"}>
    <img src='/next-js-dev-part-1/recent-posts.png' 
        alt='recent posts screenshot' 
        style={{maxWidth: '100%'}} />
</CenteredImage>
...
<CenteredImage caption={"My other two pages from my sketch mockup"}>
    <img src='/next-js-dev-part-1/projects-screenshot.png' alt='projects page screenshot' style={{maxWidth: '100%'}}/>
</CenteredImage>
